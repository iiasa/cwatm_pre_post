...
buildOptions = dict(packages = ["numpy","deap","pandas","cftime",])
...
executables = [
    Executable('calibration_single2.py', base=base, targetName = 'calibration_single2.exe')
]

setup(	
    name = "Calibration - CWATM",
    version = VERSION,
    description = "Hydrological model",
    author = "IIASA Water Security - Peter Burek et al.",
